...
public class SegreteriaCorsiController {
	...
	private Model model;
	//List<Corso> corsi;
	private ObservableList<Corso> observableList;
	...
	private void setComboItems() {
		...
		// Modo 1:
		comboCorso.setItems(FXCollections.observableList(model.getTuttiICorsi()).sorted());
	...
	/*
	 * Data una matricola devo stampare tutti i corsi a cui lo studente ̬ iscritto.
	 */
	@FXML
